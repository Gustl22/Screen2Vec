...
parser.add_argument("-d", "--data", required=True, type=str, default=None,
                    help="prefix of precomputed data to test/train model")
...
parser.add_argument("-a", "--prev_model", type=str, default=None,
                    help="previously trained model to start training from")
parser.add_argument("-v", "--net_version", type=int, default=0,
                    help="0 for regular, 1 to embed location in UIs, 2 to use layout embedding, 3 to use both, 4 with both but no description, 5 to use both but not train description, 6 to use neither but no description")
parser.add_argument("-l", "--loss", type=str, default="cel")
parser.add_argument("-t", "--test_train_split", type=str, default="",
                    help="prefix of information about train/test data split, stored when training UI model")
