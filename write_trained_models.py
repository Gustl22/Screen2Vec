...
from dataset.dataset import PrecompRicoDataset
...
dataset = PrecompRicoDataset(args.num_predictors, uis, ui_emb, descr, descr_emb, layouts, args.net_version, True,
                             screen_names)
...
if args.net_version in [4, 6, 7, 8]:
    ...
    while end_index != -1:
        ...
        vocab_UIs, vocab_descr, vocab_trace_screen_lengths, vocab_layouts, vocab_indx_map, vocab_rvs_indx, end_index = vocab.get_all_screens(
            end_index, 1024)
